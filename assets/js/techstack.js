...
const techStack = [
  ...
  },
  {
    ...
    langDesc: "<li>Spring Boot is an open source Java-based framework used to create stand-alone, production-grade Spring-based applications.</li>"
  },
  {
    langImage: "assets/images/techstack-page/flutter.png",
    langName: "Flutter",
    langDesc: "<li>Flutter is an open-source UI software development toolkit created by Google for building natively compiled applications for mobile, web, and desktop from a single codebase.</li>"
  },
  {
    langImage: "assets/images/techstack-page/go.png",
    langName: "Go",
    langDesc: "<li>Go (Golang) is an open source programming language that makes it easy to build simple, reliable, and efficient software.</li>"
  },
  {
    langImage: "assets/images/techstack-page/aws.png",
    langName: "AWS",
    langDesc: "<li>Amazon Web Services (AWS) is a comprehensive and widely adopted cloud platform, offering over 200 fully featured services from data centers globally.</li>"
  },
  {
